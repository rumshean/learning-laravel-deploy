        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                @endif
                    ...
                    <form action="/home/create1" method="post">
                    <table class="MenuClick">
                        <tr>
                            <td>
                                <h1>BNI322</h1>
                                <br>
                                <h7> Format : 16 digit di depan tambah 003 (spasi) ddmmyyyy (spasi) ddmmyyyy</h7>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <h7>Batch ID :</h7>
                                <h7> <input type="text" class="form-control" name="batch_id" value="<?php $rand = rand(1,100); $date = date("dmYis"); $batch_id= 'BNI322'.$rand.$date; echo $batch_id ?>" align="center" readonly/></h7>
                            </td>
                        </tr>
                    </table>
                    <br>
                    <table class="table" id="bni322table">
                        <tbody>
                            <tr>
                                <th>Norek</th>
                                <th>StartDate</th>
                    ...
                    var str9 = '<td><input type="text" class="form-control" name="enddate[]"/></td>';  
                                ...
                                var tableRef = document.getElementById('bni322table').getElementsByTagName('tbody')[0];
                                var newRow   = tableRef.insertRow(tableRef.rows.length);
                                //var x=document.getElementById('bni322table').insertRow(0);
