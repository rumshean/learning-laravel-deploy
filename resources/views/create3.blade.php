                ...
                @endif
                    ...
                    <table class="MenuClick">
                        ...
                        <tr>
                            <td>
                                <h7>Batch ID :</h7>
                                <h7> <input type="text" class="form-control" name="batch_id" value="<?php $rand = rand(1,100); $date = date("dmYis"); $batch_id= 'BNI360'.$rand.$date; echo $batch_id ?>" align="center" readonly/></h7>
                            </td>
                        </tr>
                    </table>
                    <br>
                    <table class="table" id="BNI360table">
                        <tbody>
                            <tr>
                                <th>Norek</th>
                                <th>StartDate</th>
                    ...
                    var str9 = '<td><input type="text" class="form-control" name="enddate[]"/></td>';  
                                ...
                                var tableRef = document.getElementById('BNI360table').getElementsByTagName('tbody')[0];
                                var newRow   = tableRef.insertRow(tableRef.rows.length);
                                //var x=document.getElementById('BNI360table').insertRow(0);
